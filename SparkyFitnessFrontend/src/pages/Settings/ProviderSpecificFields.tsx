    ...
    <>
      ...
      {provider.provider_type === 'openfoodfacts' && (
        <>
          ...
          <p className="text-sm text-muted-foreground col-span-2">
            ...
            language setting in Sparky. For more information, visit the{' '}
            <a
        ...
        <>
          ...
          <p className="text-sm text-muted-foreground col-span-2">
            {t(
              ...
              'YAZIO food searches automatically adjust to your active language preference in Sparky (supporting English, German, French, Russian, Spanish, Italian, Dutch, Polish, Portuguese, Danish, Finnish, Swedish, Czech, Hungarian, Greek, Norwegian, Turkish, Chinese, Japanese, and Korean). Other languages default to standard international database parameters.'
            )}
          </p>
        </>
      )}
      ...
      {provider.provider_type === 'garmin' && (
        <p className="text-sm text-muted-foreground col-span-2">
          ...
          <br />
          Sparky does not store your Garmin email or password. They are used
          only during login to obtain secure tokens.
        </p>
      )}
      ...
      {provider.provider_type === 'swissfood' && (
        <div className="col-span-2 space-y-2">
          ...
          <p className="text-sm text-muted-foreground">
            If your active language in Sparky is not supported, the API queries
            will default to English. For more details, see the official portal
            at{' '}
            <a
